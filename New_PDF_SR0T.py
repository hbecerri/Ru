...
nbins = 140
file = R.TFile("rebin_PDF_SR0T.root")
#file = R.TFile("mu_Test_4cat_PDF_SR0T.root")
...
h_PDF = {}
file.cd('')
R.gDirectory.cd('SR0T/ttbar')
dir = R.gDirectory.GetListOfKeys()

for key in dir:
    a = key.GetName()
    h_bkg[a] = file.Get('SR0T/ttbar/'+a).Clone()
...
fout = R.TFile("templates_pdf_SR0T.root", 'recreate')
