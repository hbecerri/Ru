...
categories=['T1']
fout = TFile('/afs/desy.de/user/h/hugobg/public/theta/CMSSW_8_0_24/src/Combine_Limits/muon_mle/mu_Test_4cat_q2_SR1T.root', 'recreate')
...
for cat in categories:
    ...
    if cat == 'T1':
        ...
        for key_sample in samplelist:
            ...
            gDirectory.cd('/afs/desy.de/user/h/hugobg/public/theta/CMSSW_8_0_24/src/Combine_Limits/muon_mle/mu_Test_4cat_q2_SR1T.root:/SR1T/'+key_sample)
            if key_sample == 'DATA':
